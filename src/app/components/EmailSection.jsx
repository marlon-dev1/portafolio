...
const EmailSection = () => {
    ...
    return (
        <section id="contact" className="relative grid gap-4 py-20 mx-8 mt-12 md:grid-cols-2 ">
            ...
            <div>
                ...
                <div className="flex flex-row gap-2 socials">
                    ...
                    <Link target="_blank" href="https://www.linkedin.com/in/marlon-estiben-varon-gonzalez-3167ba194/">
